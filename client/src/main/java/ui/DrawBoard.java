...
//                if ((j%2 == 0 && i%2 == 0) || (j%2 == 1 && i%2 == 1)) {
            if ((j % 2 == 0)) {
                setWhite(out);
                drawChessBoardRow(out, j + 1, SET_BG_COLOR_WHITE, headers[j]);
            } else {
                setBlack(out);
                drawChessBoardRow(out, j + 1, SET_BG_COLOR_BLACK, headers[j]);
            }

        }
//            drawIndY(out, headers[i]);
//            setBlack(out);
//            out.println(EMPTY);
    }
        ...
        for (int i = 0; i < 8; i++) {
            ...
            if (piece != null) {
                switch (piece.getPieceType()) {
                    case ROOK -> {
                        if (piece.getTeamColor() == ChessGame.TeamColor.BLACK) out.print(BLACK_ROOK);
                        else {
                            out.print(SET_TEXT_COLOR_BLACK);
                    ...
                    case BISHOP -> {
                        if (piece.getTeamColor() == ChessGame.TeamColor.BLACK) out.print(BLACK_BISHOP);
                        else {
                            out.print(SET_TEXT_COLOR_BLACK);
                    ...
                    case KNIGHT -> {
                        if (piece.getTeamColor() == ChessGame.TeamColor.BLACK) out.print(BLACK_KNIGHT);
                        else {
                            out.print(SET_TEXT_COLOR_BLACK);
                    ...
                    case PAWN -> {
                        if (piece.getTeamColor() == ChessGame.TeamColor.BLACK) out.print(BLACK_PAWN);
                        else {
                            out.print(SET_TEXT_COLOR_BLACK);
                    ...
                    case QUEEN -> {
                        if (piece.getTeamColor() == ChessGame.TeamColor.BLACK) out.print(BLACK_QUEEN);
                        else {
                            out.print(SET_TEXT_COLOR_BLACK);
                    ...
                    case KING -> {
                        if (piece.getTeamColor() == ChessGame.TeamColor.BLACK) out.print(BLACK_KING);
                        else {
                            out.print(SET_TEXT_COLOR_BLACK);
